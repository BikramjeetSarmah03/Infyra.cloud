...
import { Textarea } from "@infyra/ui/components/textarea";
...
function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
	return (
		// biome-ignore lint/a11y/useSemanticElements: input-group is a styling wrapper around arbitrary inputs/addons/buttons, not a <fieldset> grouping of form controls
		<div
...
function InputGroupAddon({
	...
	const focusControl = (currentTarget: HTMLElement) => {
	...
	return (
		// biome-ignore lint/a11y/useSemanticElements: input-group-addon is a styling wrapper (icon/text/button slot) around the actual input, not a <fieldset> grouping of form controls
		<div
			role="group"
